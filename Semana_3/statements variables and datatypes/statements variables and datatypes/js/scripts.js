...
//En este caso el método .toUpperCase sirve tan solo para strings, ni para objects ni para arrays.
*/
...
if( keep_rolling === true ){
	...
	console.log("It´s not the true answer");
}else{
	console.log( "I'm in!!" );
...
console.log( song.title = "Help");
console.log( song.year = 1968);
...
for( var i = numbers.length; i >= 0; i--){
	console.log(emptyArray = numbers[i]);
}
